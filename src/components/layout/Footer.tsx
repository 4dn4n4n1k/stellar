          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex flex-col gap-4 mb-6">
              <a
                ...
                download
                className="inline-flex items-center gap-2 text-sm text-white/70 hover:text-teal-400 transition-colors duration-180 focus-visible:ring-2 focus-visible:ring-teal-400 focus-visible:outline-none"
              >
                <Download size={16} />
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-8 h-8 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center text-white/60 hover:text-white transition-all duration-180 focus-visible:ring-2 focus-visible:ring-teal-400 focus-visible:outline-none"
              >
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <Link
                    key={link.href}
                    href={link.href}
                    className={`transition-colors duration-180 text-sm flex items-center gap-2 group py-1.5 focus-visible:ring-2 focus-visible:ring-teal-400 focus-visible:outline-none ${isActive ? 'text-teal-400' : 'text-white/60 hover:text-teal-400'}`}
                  >
                    <span className={`transition-colors duration-180 ${isActive ? 'text-teal-400' : 'text-white/30 group-hover:text-teal-400'}`}>•</span>
                    {link.label}
                  </Link>
                );
              })}
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-[8px] bg-white/5 flex items-center justify-center shrink-0 mt-0.5">
              ...
              >
                <div className="w-10 h-10 rounded-[8px] bg-white/5 flex items-center justify-center shrink-0 group-hover:bg-white/10 transition-colors duration-180 mt-0.5">
            ...
            <nav className="flex flex-col gap-1">
              {[
                ...
                <Link
                  key={service}
                  href="/services"
                  className="text-white/60 hover:text-teal-400 transition-colors duration-180 text-sm flex items-center gap-2 group py-1.5 focus-visible:ring-2 focus-visible:ring-teal-400 focus-visible:outline-none"
                >
