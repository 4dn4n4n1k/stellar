    ...
    <footer className="bg-navy-950 text-white border-t border-white/5">
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 mb-6">
              <a
                ...
                download
                className="inline-flex items-center gap-2 text-sm text-white/70 hover:text-white transition-colors duration-180"
              >
                <Download size={16} />
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-8 h-8 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 flex items-center justify-center text-white/60 hover:text-white transition-all duration-180"
              >
            ...
            <nav className="flex flex-col gap-3">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-white/60 hover:text-white transition-colors duration-180 text-sm flex items-center gap-2 group"
                >
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <span className="w-1.5 h-5 rounded-full bg-orange-500 block shrink-0" />
              <h3 className="text-white font-bold text-lg font-heading">
                Contact Us
              </h3>
            </div>
                  ...
                  <div className="flex flex-col gap-0.5">
                    {siteConfig.phones.map((phone) => (
                      <a
                        key={phone}
                        href={`tel:${phone}`}
                        className="text-white/60 text-sm hover:text-white transition-colors duration-180"
                      >
                        {phone}
                      </a>
                    ))}
